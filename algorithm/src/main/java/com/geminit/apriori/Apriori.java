...
public class Apriori {
     ...
     * @return
     */
    private String expect(String a, String b) {
        String result = "";

        String[] aArr = a.split(ITEM_SPLIT);
        String[] bArr = b.split(ITEM_SPLIT);
    ...
    public static void main(String[] args) {
        ...
        dataList.add("日用电;季度用电;");
        dataList.add("日用电;统计日期;季度用电;统计月份;");
