...
public class CollectSpark1and2 {
    ...
    private static String PIPELINE_JAR_NAME = "cdap-data-pipeline" + "-" + CollectUtils.CDAP_VERSION + ".jar";
    private static String STREAM_JAR_NAME = "cdap-data-streams" + "-" + CollectUtils.CDAP_VERSION + ".jar";
    ...
    public static void CollectSpark1(File spark1) throws IOException {
        ...
        for (File file : pipeline1Target.listFiles()) {
            if (file.getName().equals("cdap-data-pipeline" + "-" + CollectUtils.CDAP_VERSION + ".jar")) {
        ...
        for (File file : stream1Target.listFiles()) {
            if (file.getName().equals("cdap-data-streams" + "-" + CollectUtils.CDAP_VERSION + ".jar")) {
        ...
        for (File file : reportTarget.listFiles()) {
            if (file.getName().equals("cdap-program-report" + "-" + CollectUtils.CDAP_VERSION + ".jar")) {
    ...
    public static void CollectSpark2(File spark2) throws IOException {
        ...
        for (File file : pipeline2Target.listFiles()) {
            if (file.getName().equals("cdap-data-pipeline2_2.11" + "-" + CollectUtils.CDAP_VERSION + ".jar")) {
        ...
        for (File file : stream2Target.listFiles()) {
            if (file.getName().equals("cdap-data-streams2_2.11" + "-" + CollectUtils.CDAP_VERSION + ".jar")) {
